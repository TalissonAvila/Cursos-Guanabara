 ...
 * @author talisson
 */
public class LinguagemTela extends javax.swing.JFrame {

    /**
     * Creates new form LinguagemTela
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/linguas.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel2.setText("A linguagem do seu sistema é");
    ...
    private void btnCliqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCliqueActionPerformed
       ...
       lblMensagem.setText(idioma.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LinguagemTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LinguagemTela().setVisible(true);
            }
        });
    }
